...
fn default_layout() -> Vec<LayoutItem> {
    ...
    vec![
        LayoutItem { id: "0".into(), x: 0, y: 0, w: 2, h: 2, resize_handles: handles.clone(), ..Default::default() },
        LayoutItem { id: "1".into(), x: 2, y: 0, w: 2, h: 2, resize_handles: handles.clone(), ..Default::default() },
        LayoutItem { id: "2".into(), x: 4, y: 0, w: 2, h: 2, resize_handles: handles.clone(), ..Default::default() },
        LayoutItem { id: "3".into(), x: 6, y: 0, w: 2, h: 2, resize_handles: handles.clone(), ..Default::default() },
        LayoutItem { id: "4".into(), x: 8, y: 0, w: 2, h: 2, resize_handles: handles.clone(), ..Default::default() },
    ]
}
